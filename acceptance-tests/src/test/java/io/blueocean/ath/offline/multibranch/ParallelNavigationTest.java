...
public class ParallelNavigationTest {
    ...
    /**
     * Checks the ability to click between parallel branches repeatedly,
     * and verifies that the correct branch is shown in the log as we go..
     * You should be able to click between one and the other and see it progressing.
     */
    @Test
    @Ignore
    public void parallelNavigationTestVerified () throws IOException, GitAPIException, InterruptedException {
        String pipelineName = "ParallelNavigationTest_tested";
        ...
        wait.click(By.xpath("//*[contains(@class, 'pipeline-node')][3]"));
        wait.until(By.xpath("//*[text()=\"secondBranch\"]"));
        // Verify that the log header has changed to show "secondBranch"
        // wait.until(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("div.log-header__section.selected"),"secondBranch"));

        wait.click(By.xpath("//*[contains(@class, 'pipeline-node')][3]"));
        // wait.click(By.xpath("//*[text()=\"firstBranch\"]"));
        // Verify that the log header has changed to show "firstBranch"
        // wait.until(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("div.log-header__section.selected"),"firstBranch"));
